...
CREATE TABLE `lancamentos` (
  ...
  `conta_usuario_credito_id` int(10) unsigned DEFAULT NULL,
  `conta_usuario_debito_id` int(10) unsigned DEFAULT NULL,
  `valor` decimal(10,2) NOT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_lancamentos_contas_usuarios_idx` (`conta_usuario_credito_id`),
